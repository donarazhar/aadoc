                ...
                <div class="p-6 text-slate-900">
                    <form method="POST" action="{{ route('admin.categories.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" class="border-slate-300 focus:border-alazhar focus:ring-alazhar rounded-md shadow-sm block mt-1 w-full" rows="3">{{ old('description') }}</textarea>
                        ...
                        <div class="mb-6 flex items-center">
                            <input type="checkbox" name="is_hidden" id="is_hidden" value="1" {{ old('is_hidden') ? 'checked' : '' }} class="rounded border-slate-300 text-alazhar shadow-sm focus:ring-alazhar focus:ring-offset-0 focus:ring-2">
